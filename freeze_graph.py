# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 06:02:09 2020
...
#added for the initialize_uninitialized
...
def freeze_graph_with_def_protos(input_graph_def,
  ...
  if output_graph: 
    with gfile.GFile(output_graph, "wb") as f:
      ...
      tf.io.write_graph(output_graph_def, "", "./hourglass/tf_dnn_1_test/frozen_inference_graph.pbtxt", as_text=True) # added to produce a text file

  return output_graph_def

# added routine to original code, to handle unitialized variables
